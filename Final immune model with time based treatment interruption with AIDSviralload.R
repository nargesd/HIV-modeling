...
main.program.AIDS.viral <- function(tmax,int.period){
...
a.plot <- plot(main[,6]*1000,type="l",xlab="time (days)",ylab="virus per ml",main=paste("Viral load with interruption period:",int.period,"day(S)") , col=int.period+3, lwd=2,xlim=c(0,tmax),log="y")
